...
- Justificación de inasistencias por parte de apoderados (subiendo documentos).
- Reemplazar el sistema de asistencia actual.
- Uso por otras escuelas (multi-escuela).
